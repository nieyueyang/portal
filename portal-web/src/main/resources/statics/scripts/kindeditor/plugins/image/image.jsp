...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			var imageUploadJson = (typeof KE.g[id].imageUploadJson == 'undefined') ? '<%=request.getContextPath()%>/kindeditor-image-upload.htm' : KE.g[id].imageUploadJson;
				...
				<ul class="table">
					<li>
						<div id="tab2" style="display:none;">
							...
							<input type="button" id="viewServer" name="viewServer" style="display:none;" value="" />
						</div>
