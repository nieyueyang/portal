	...
	var bigAutocomplete = new function(){
		...
		this.init = function(){
			...
			$("#bigAutocompleteContent").delegate("tr", "click", function() {
				...
				$("#forwardCompanyName").val($(this).find("div:last").html());
				$("#payCompanyName").val($(this).find("div:last").html());
				$("#receivingParty").val($(this).find("div:last").html());
				$("#endUserName").val($(this).find("div:last").html());
