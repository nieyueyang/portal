	...
	var form = $('#theForm').validateForm(
			{
				...
				//var tempSupplyAmt = $("#tempSupplyAmt").val();
			    //var supplyAmt = $("#supplyAmt").val();
		       //if(parseFloat(supplyAmt) <parseFloat(tempSupplyAmt) ){
			    	//alert("补缴金额不能小于需补缴金额，请重新输入！");
			    	//return false;
			    //}
...
function callbackforadd(result){
	...
	if(params.type == 'error' || params.type == 'warn'){	
		...
		//var listUrl = appServer + "/contract/entrust/list.htm";
