...
var prjTypeUrl = {
	nodesURL :appServer +"/listing/loadForTreeMulPar.htm?isActive=true"
};
var metaErrors = "";
var metaSubmitValue = "";
$(function() {
 ...
 * @param parCode，多个以“,”分割
 *            查询parCode下的品种树
 */
function showPrjTypeSel_MulPar(followObj, yesFn, parCode) {
...
function queryTreeByShortName() {     
	...
	prjTypeTree = reloadPrjTypeTree('prjTypeTreeUL', null, function(event,
			treeId, treeNode, msg) {
		showPrjTypeArtBox(followObjQuery, '', yesFnQuery);
		if(shortName !="")
	...
	},null,parCodeQuery,encodeURI(shortName));
