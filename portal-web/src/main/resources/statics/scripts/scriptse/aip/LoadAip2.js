 /*
	...
	s += "classid=clsid:FF1FE7A0-0578-4FEE-A34E-FB21B277D561 codebase='./HWPostil2.ocx#version=3,0,9,8'>"
...
if(navigator.userAgent.indexOf("MSIE")>0){
	s = "<OBJECT id=HWPostil1 align='middle' style='LEFT: 0px; WIDTH: 100%; TOP: 0px; HEIGHT: 680px'"
		+ "classid=clsid:FF1FE7A0-0578-4FEE-A34E-FB21B277D561 codebase='"+appServer+"/scripts/aip/HWPostil2.cab#version=3,1,0,4'>"
...
if(navigator.userAgent.indexOf("Chrome")>0){
	s = "<object id='HWPostil1' type='application/x-itst-activex' align='baseline' border='0'"
		...
		+ "progid='"+appServer+"/scripts/aip/HWPostil2.cab#version=3,1,0,4'"
